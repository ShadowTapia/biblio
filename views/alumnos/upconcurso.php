...
$this->title = 'Modificar Alumnos por Curso ' . Yii::$app->session->get('nameAno');
                ...
                [
                    ...
                    'buttons' => [
                        'update' => function($url, $model){
                            return Html::a("<span class='glyphicon glyphicon-pencil'></span>",['alumnos/update','id'=>$model->idalumno, 'fuente' => 2],
                                ['class' => 'btn btn-circle btn-success btn-sm','title' => 'Modificar Alumno']);
                        },
                    ],
                ],
            ];
