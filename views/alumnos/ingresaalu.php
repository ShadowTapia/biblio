...
<?php $form = ActiveForm::begin([
    'method' => 'post', 'id' => 'formIngAlus', 'class' => 'form-horizontal',
...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-3">
            <?= $form->field($modelPivot, 'idCurso')->dropDownList(
                Cursos::getListCursos(),
                ['class' => 'form-control', 'style' => 'width:100%;', 'prompt' => 'Seleccione Curso', 'id' => 'idCurso']
            )->label('Curso*') ?>
        </div>
    </div>
