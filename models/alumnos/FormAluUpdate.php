 ...
 */
class FormAluUpdate extends Model
{
    public $rutalumno;
    public $digrut;
    public $sexo;
    ...
    public function rules()
    {
        return [
            ...
            [['digrut','nacionalidad','sexo'],'string','max'=> 1],
            ['nombrealu','string','length'=>[3,50],'message'=>'Mínimo 3 y máximo 50 caracteres'],
            [['fechanac','fechaing','fecharet'], 'date','format' => 'dd-MM-yyyy'],
            [['fechanac','fechaing','fecharet','sexo'],'safe'],
            [['fechanac','fechaing','fecharet'],'default','value'=>null],
